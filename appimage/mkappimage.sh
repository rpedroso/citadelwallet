...
./linuxdeploy-x86_64.AppImage --executable ../build/release/citadelwallet --desktop-file ../src/citadelwallet.desktop --appdir ./AppDir --output appimage --plugin qt --icon-file ../src/images/cryptonote.png
